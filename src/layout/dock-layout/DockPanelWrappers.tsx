...
/**
 * Thin wrapper that reads project context and passes props to PullRequestsPanel.
 * Shows a placeholder when no project is selected.
 * Only renders for local projects (canManagePRs capability).
 */
