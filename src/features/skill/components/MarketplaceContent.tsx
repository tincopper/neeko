...
const MarketplaceContent: React.FC<MarketplaceContentProps> = React.memo(({ onSkillInstalled }) => {
  ...
  return (
    <div className="h-full min-h-0 flex flex-col overflow-hidden">
      <div className="shrink-0">
        ...
        {!searchQuery && <LeaderboardToggle value={board} onChange={setBoard} disabled={loading} />}
