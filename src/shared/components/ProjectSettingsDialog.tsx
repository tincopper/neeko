...
// eslint-disable-next-line import/no-restricted-paths -- ProjectSettingsDialog needs to call agent API for saving project agents
import { setProjectAgents } from '../../features/agent/api/agentApi';
// eslint-disable-next-line import/no-restricted-paths -- ProjectSettingsDialog needs to call project API for setting IDE
    ...
    >
      <DialogContent className="min-w-[400px] max-w-[500px]">
        ...
        <div className="relative" ref={agentRef} style={{ width: '100%', marginTop: 4 }}>
          ...
          >
            <AgentIcon
              icon={agents.find((a) => a.id === selectedAgentId)?.icon ?? null}
              size={16}
              fallback="&#9889;"
            />
        ...
        <div className="relative" ref={ideRef} style={{ width: '100%', marginTop: 4 }}>
          ...
          >
            {selectedIdeId?.startsWith('custom:') ? (
              <span
                className="text-[14px] w-[18px] h-[18px] object-contain"
                style={{ fontSize: 16 }}
              >
                &#128187;
              </span>
              ...
              <img
                src={getIdeIconSrc(ideDisplay.icon)}
