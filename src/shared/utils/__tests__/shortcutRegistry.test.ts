...
describe('shortcutRegistry', () => {
  ...
  describe('P3 editor navigation bindings', () => {
    ...
    it('should_bind_direct_tab_cycle_to_idea_defaults_and_keep_ctrl_tab_and_nav_history', () => {
      const resolved = resolveBindings({});
      // 与 IDEA 对齐：Alt+Left/Right 默认切换前后 tab；
      // Ctrl+Tab / Ctrl+Shift+Tab 保留为 MRU 切换入口。
