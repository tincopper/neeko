...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::get_unversioned_files,
            ...
            commands::wsl_get_commit_log,
            commands::wsl_get_commit_detail,
            commands::wsl_get_all_branches,
            ...
            commands::remote_get_commit_log,
            commands::remote_get_commit_detail,
            commands::remote_get_all_branches,
