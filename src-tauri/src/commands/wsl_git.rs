...
pub fn refresh_wsl_git_info(distro: String, project_path: String) -> Result<GitInfo, String> {
    ...
    {
        crate::remote::get_wsl_git_info(&distro, &project_path).map_err(|e| e.to_string())
    }
...
pub fn get_wsl_file_diff_command(
    ...
    #[cfg(target_os = "windows")]
    {
        crate::remote::get_wsl_file_diff(&distro, &project_path, &file_path)
...
pub fn wsl_checkout_branch(
    ...
    #[cfg(target_os = "windows")]
    {
        crate::remote::run_wsl_git(&distro, &project_path, &["checkout", &branch_name])
            .map(|_| ())
            .map_err(|e| e.to_string())
    }
    #[cfg(not(target_os = "windows"))]
...
pub fn wsl_create_branch(
    ...
    #[cfg(target_os = "windows")]
    {
        crate::remote::run_wsl_git(&distro, &project_path, &["branch", &branch_name])
            .map(|_| ())
            .map_err(|e| e.to_string())
    }
    #[cfg(not(target_os = "windows"))]
...
pub fn wsl_create_worktree(
    ...
    #[cfg(target_os = "windows")]
    {
        ...
        crate::remote::run_wsl_git(&distro, &project_path, &args)
            .map(|_| ())
            .map_err(|e| e.to_string())
    }
    #[cfg(not(target_os = "windows"))]
