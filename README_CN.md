...
| 主界面 | 文件管理面板 | Skills管理面板                               |
|--------|--------|------------------------------------------|
| ![主界面](docs/.img/index.png) | ![文件管理](docs/.img/files.png) | ![skills管理](docs/.img/skill-manager.png) |
...
- **主题同步** — 应用主题（dark、light、one-dark-pro、claude）自动同步到本地、WSL 和 SSH 远程项目的 OpenCode TUI 配置
