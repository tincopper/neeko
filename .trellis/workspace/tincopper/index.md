...
| 212 | 2026-09-17 | DAP 续拆：BackendRegistry / DapContext / launch / breakpoints::service | - | `main` |
| 211 | 2026-09-17 | DAP manager 按 neeko-check 规范重构（5 阶段） | - | `main` |
| 210 | 2026-09-16 | source-identity slice3: check pass + archive | `ae78567e` | `main` |
...
| 155 | 2026-08-30 | Archive lsp-navigation-ux (P0-P2 landed, splash + scroll fixes included) | `2f9a6f82` | `main` |
| 154 | 2026-08-30 | Archive drag-tab-to-pin (4 scope extensions + neeko-check fixes) | `cd02adb7` | `main` |
...
| 127 | 2026-08-11 | 收敛命令执行三重枚举（GitTransportKind/ExecTarget/ProjectEnvironment） | `e45d9b57` | `main` |
| 126 | 2026-08-11 | 平台差异集中化重构：neeko-check 审查 + 三项优化 + 提交 | `7ea9ae42` | `main` |
...
| 69 | 2026-06-01 | Remove project name and branch name from TitleBar | `59654bbcb099640ae1b72f7ff8d280e7a8ec33b7` | `refactor/architecture-optimization` |
| 68 | 2026-06-01 | watcher: only watch active project | `688d27b` | `refactor/architecture-optimization` |
| 67 | 2026-05-31 | Spec compliance refactor complete - Phases A, B, C | `f72ba98`, `0e0c84d`, `23c4588` | `refactor/architecture-optimization` |
...
| 51 | 2026-05-27 | Refactor: introduce useUnifiedProjectList, simplify ProjectsPanel | `4823ef4` | `refactor/architecture-optimization` |
